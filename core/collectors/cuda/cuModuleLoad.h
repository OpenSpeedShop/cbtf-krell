...
/**
 * Entry callback for cuModuleLoad().
 */
inline void cuModuleLoad_enter_callback(
    ...
    )
{
    ...
    if (debug)
    {
        printf("[CBTF/CUDA] cuModuleLoad_enter_callback()\n");
    }
#endif
...
/**
 * Exit callback for cuModuleLoad().
 */
inline void cuModuleLoad_exit_callback(
    const cuModuleLoad_params* const params
    )
{
#if !defined(NDEBUG)
    if (debug)
    {
        printf("[CBTF/CUDA] cuModuleLoad_exit_callback()\n");
    }
#endif
