...
/**
 * Entry callback for cuModuleLoadData().
 */
inline void cuModuleLoadData_enter_callback(
    ...
    )
{
    ...
    if (debug)
    {
        printf("[CBTF/CUDA] cuModuleLoadData_enter_callback()\n");
    }
#endif
...
/**
 * Exit callback for cuModuleLoadData().
 */
inline void cuModuleLoadData_exit_callback(
    const cuModuleLoadData_params* const params
    )
{
#if !defined(NDEBUG)
    if (debug)
    {
        printf("[CBTF/CUDA] cuModuleLoadData_exit_callback()\n");
    }
#endif
