...
/**
 * Entry callback for cuModuleLoadFatBinary().
 */
inline void cuModuleLoadFatBinary_enter_callback(
    ...
    )
{
    ...
    if (debug)
    {
        printf("[CBTF/CUDA] cuModuleLoadFatBinary_enter_callback()\n");
    }
#endif
...
/**
 * Exit callback for cuModuleLoadFatBinary().
 */
inline void cuModuleLoadFatBinary_exit_callback(
    const cuModuleLoadFatBinary_params* const params
    )
{
#if !defined(NDEBUG)
    if (debug)
    {
        printf("[CBTF/CUDA] cuModuleLoadFatBinary_exit_callback()\n");
    }
#endif
    ...
    static char* kModulePath = "<Module from Fat Binary>";
