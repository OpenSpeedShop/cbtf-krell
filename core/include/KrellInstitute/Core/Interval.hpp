...
#ifndef _KrellInstitute_Core_Interval_
#define _KrellInstitute_Core_Interval_
...
namespace std {
     ...
     */
    template <typename T>
    struct less<KrellInstitute::Core::Interval< T > > :
	binary_function<const KrellInstitute::Core::Interval< T >&,
			const KrellInstitute::Core::Interval< T >&,
			bool>
    {

	/** Evaluator for this predicate. */
	bool
	operator()(const KrellInstitute::Core::Interval< T >& lhs,
		   const KrellInstitute::Core::Interval< T >& rhs) const
	{
