...
struct CBTF_hwcsamp_parameters {
    uint64_t sampling_rate;  /**< Sampling threshhold in hwc events. */
    char CBTF_hwcsamp_event[512];      /**< hwc event (PAPI event code) to sample*/
};



/** Structure of the blob containing hwcsamp_start_sampling()'s arguments. */
struct CBTF_hwcsamp_start_sampling_args {
