...
** Copyright (c) 2011-12 The Krell Institute. All Rights Reserved.
**
...
/** @file
 *
 * Specification of the HWC sampling collector data blobs.
 *
 */

struct CBTF_hwcsamp_event {
    uint64_t hwccounts[6];
};


/** Structure of the blob containing our performance data. */
struct CBTF_hwcsamp_data {
