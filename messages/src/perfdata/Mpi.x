...
** Copyright (c) 2011-12 The KrellInstitute. All Rights Reserved.
**
...
/** Structure of the blob containing mpi start tracing arguments. */
struct CBTF_mpi_start_sampling_args {
