...
/** @file
 *
 * Specification of the Ompt collector's blobs.
 *
 */

/** Structure of the blob containing our parameters. */
struct CBTF_ompt_parameters {
    bool none;
};


/** Structure of the blob containing start_tracing()'s arguments. */
struct CBTF_ompt_start_sampling_args {
