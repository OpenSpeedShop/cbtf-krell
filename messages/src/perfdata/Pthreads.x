...
/** @file
 *
 * Specification of the Pthread collector's blobs.
 *
 */

/** Structure of the blob containing our parameters. */
struct CBTF_pthreads_parameters {

    /** Flags indicating if each Pthread function is to be traced. */
    uint8_t traced[1024];
...
struct CBTF_pthreads_start_sampling_args {
