...
/** @file
 *
 * Definition of the CBTF_GetPCFromContext() function.
 *
 */
 ...
 * signal handler or from calling CBTF_GetContext().
 *
 ...
 * @ingroup RuntimeAPI
 */
void CBTF_SetPCInContext(uint64_t value, ucontext_t* context)
{
    /* Check preconditions */
    Assert(context != NULL);
