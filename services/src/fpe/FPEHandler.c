...
/** @file
 *
 * Definition of the CBTF_FPEHandler() function.
 *
 */

#include "KrellInstitute/Services/Common.h"
#include "KrellInstitute/Services/FPE.h"
...
typedef struct {
    ...
    CBTF_FPEEventHandler fpe_handler;
 ...
 * @ingroup RuntimeAPI
 */
void CBTF_FPEHandler(CBTF_FPEType fpe_type,
		       const CBTF_FPEEventHandler handler)
{
//fprintf(stderr,"ENTERED FPE CBTF_FPEHandler with fpe_type %d\n",fpe_type);
    ...
    /* eventually use fpe_type arg.  Need to convert from
       CBTF_FPEType to type (enum) expected by feenableexcept */
