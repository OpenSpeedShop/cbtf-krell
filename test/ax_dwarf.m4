...
AC_DEFUN([AC_PKG_TARGET_LIBDWARF], [
    ...
    if test -f  $target_libdwarf_dir/$abi_libdir/libdwarf.so -o $target_libdwarf_dir/$abi_libdir/libdwarf.a; then
       found_target_libdwarf=1
       TARGET_LIBDWARF_LDFLAGS="-L$target_libdwarf_dir/$abi_libdir"
    elif test -f  $target_libdwarf_dir/$alt_abi_libdir/libdwarf.so -o $target_libdwarf_dir/$alt_abi_libdir/libdwarf.a; then
       found_target_libdwarf=1
